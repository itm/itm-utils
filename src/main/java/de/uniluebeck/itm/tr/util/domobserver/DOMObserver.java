 ...
 * {@link de.uniluebeck.itm.tr.util.domobserver.DOMObserver#updateCurrentDOM()} the observer "advances in time" by
...
public interface DOMObserver extends Runnable, Listenable<DOMObserverListener> {
	 ...
	 * 		de.uniluebeck.itm.tr.util.domobserver.DOMObserver#updateCurrentDOM()}, a totally different state or {@code null}
