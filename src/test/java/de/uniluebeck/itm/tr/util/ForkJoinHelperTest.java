...
import static de.uniluebeck.itm.tr.util.ForkJoinHelper.fork;
import static de.uniluebeck.itm.tr.util.ForkJoinHelper.join;
...
public class ForkJoinHelperTest {
	...
	public void testSuccessfulForkJoin() throws Exception {
		...
		final BiMap<Callable<String>, String> resultMap = join(fork(callables, executorService));
	...
	public void testOmittedFailingForkJoin() throws Exception {
		...
		final BiMap<Callable<String>, String> resultMap = join(fork(callables, executorService), true);
