...
public class SettableFutureMapTest {
	...
	private static final ListeningExecutorService STE = sameThreadExecutor();
	...
	public void setUp() throws Exception {
		...
		mapWithOneCompleteEntry = newHashMap();
		mapWithOneIncompleteEntry = newHashMap();
		mapWithMultipleCompleteEntries = newHashMap();
		mapWithMultipleIncompleteEntries = newHashMap();
		mapWithMultipleEntriesAndOneIncompleteEntry = newHashMap();
		mapWithMultipleEntriesAndTwoIncompleteEntries = newHashMap();
	...
	public void testListenerOnMapWithOneEntryIsNotNotifiedIfEntryIsNotCompleted()
		...
		Mockito.verify(listener, Mockito.never()).run();
	}
